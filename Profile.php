		...
		<div id="content">
			<?php
				if($checksession)
				{
					...
					echo'<h2>پروفایل:</h2>';
					echo'<p dir="rtl">';
						echo'<h4><b>نام کاربری: </b>'.$row[1].'</h4>';
						echo'<h4><b>پسوورد : </b>'.$row[2].'</h4>';
						echo'<h4><b>ایمیل: </b>'.$row[3].'</h4>';
						echo'<h4><b>تاریخ عضویت: </b>'.$row[5].'</h4>';
						echo'<h4><b>زمان عضویت: </b>'.$row[4].'</h4>';
						echo'<h4><b>نام: </b>'.$row[6].'</h4>';
						echo'<h4><b>نام خانوادگی: </b>'.$row[7].'</h4>';
						if($checkadmin)echo'<h4><b>ادمین: </b>'.$row[9].'</h4>';
						echo'<h4><b>علایق،تحصیلات و ....: </b>'.$row[8].'</h4>';
					echo'</p>';
					...
					<?php	
						if(isset($_POST["username"]) || $checksession)
						{
							if($checksession)
							{
									...
									echo '<h4 align="center"><a href="index.php" target="_self">صفحه اصلی</a></h4>';

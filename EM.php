...
<div id="wrapper" class="container">
	...
	<div id="page">
		<div id="content">
			<?php
				...
				{//_SESSION['username']
					...
					$date=date("Y/m/d");
					$id=0;
					$sq="INSERT INTO Myposts (id,title,writer,time,date,text) VALUES 
					('{$id}','{$_POST['title']}','{$_SESSION['username']}','{$time}','{$date}','{$_POST['text']}')";
					$res=mysqli_query($con,$sq);
					if(!$res)die('ERROR:'.mysqli_connect_errno($res).mysqli_connect_errno($res));
					else echo 'مطلب ارسال شد.';
				}
				else
				{
				echo'<form method="post">';
				echo'تیتر:<br><input type="text" name="title"><br>';
				echo'متن:<br><textarea rows="20" cols="66" dir="rtl" name="text">';
				echo'</textarea><br>';
		...
		<div class="block">
			...
			if($checksession&&isset($_POST["title"])){
			echo'<div class="block">';
			...
			<!-- ------------------------------------------------- -->
			<div class="block">
				<h2 style="background: #48CFAD;">لینکدونی</h2>
					<div class="cnt">
						<a href="https://www.google.com/?gws_rd=ssl" target="_blanck"><h3>Google</h3></a><br>
						<a href="http://www.helli.ir/portal/" target="_blanck"><h3>دبیرستان علامه حلی تهران</h3></a><br>
						<a href="http://www.webook.ir/" target="_blanck"><h3>Webook</h3></a><br>
						<a href="http://www.firststep.ir/" target="_blanck"><h3>Firststep</h3></a>
					</div>
			</div>
			<!-- ------------------------------------------------- -->
			<!-- ------------------------------------------------- -->

...
<div id="wrapper" class="container">
	...
	<div id="page">
		<div id="content">
				<form method="post">
				نام شما:<br><input type="text" name="sender"><br>
				ایمیل شما:<br><input type="text" name="sender"><br>
				متن:<br><textarea rows="4" cols="50" dir="rtl" name="text">
				</textarea> <br>
				<input type="submit" value="Send" Onclick="CheckEnter("password");"><input type="reset" name="Reset">
				</form>
				<p>
				تلفن:
				0123456789
				</p><br>
				<a href="mailto:me.adib@chmail.ir">email</a>
		</div>
		<bgright>
		<div id="sidebar">
		<!-- ------------------------------------------------- -->
